...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    test_volume_cube = calc_volume_of_cube( 6 )
    self.assertEqual( 216, test_volume_cube )
    pass

  #Given a String, return the String reversed
  def test_reverse_string(self):
    test_string = "This string will be reversed"
    string_reversed = reverse_string(test_string[::-1])
    self.assertEqual( "This string will be reversed", string_reversed )


  #Given a value in farenheit, convert this into celsius.
 
  def test_fahrenheit_to_celsius(self):
    temp_farenheit_to_celsius = convert_farenheit_to_celsius ( 45 )
    self.assertEqual( 7.2, temp_farenheit_to_celsius)
